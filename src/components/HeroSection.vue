...
<template>
  <section
    class="relative min-h-screen flex flex-col items-center justify-end pb-32 md:pb-64 bg-transparent text-white pt-32 md:pt-64 px-4 md:px-6"
    :style="{ opacity: opacity }">
    <!-- Título principal SEM movimentação -->
    <div class="relative">
      <!-- <p>opacidade {{ opacity }}</p> -->
      <h1
        class="text-4xl sm:text-5xl md:text-8xl font-extrabold mb-4 font-terminal text-terminal typing-effect">
        Olá, sou Mário!
      </h1>
    </div>
    ...
    <div
      ...
      <p class="text-base sm:text-lg md:text-2xl text-gray-300 mt-6">
